...
LED_TYPE caps_led = { 187, 126, 15 };
LED_TYPE num_led = { 187, 126, 15 };
LED_TYPE scroll_led = { 187, 126, 15 };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_wkl(
    KC_TRNS,  KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS,           KC_PSCR, KC_TRNS,KC_HOME, KC_END,
